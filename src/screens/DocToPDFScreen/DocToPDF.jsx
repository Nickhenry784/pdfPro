...
import ConvertDocToPDF from '../../axios/ConvertDocToPDF';
...
const DocToPDF = () => {
  ...
  const onClickConvertBtn = async () => {
    ...
    try {
      ...
      const docToPdfPath = `${RNFS.DocumentDirectoryPath}/doctopdf-${dateString}.pdf`;

      const namePDF = `doctopdf-${dateString}.pdf`;
      let response = await ConvertDocToPDF.post(name, dataBase64);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView
        ...
        <Text style={styles.title}>Word DOC to PDF</Text>
        <Text style={styles.description}>
          Convert Word DOC documents to PDF, fast and accurate
        </Text>
        <View style={styles.btnView}>
          {imagesPicker.length === 0 ? (
            <TouchableOpacity
              ...
              <Text style={styles.btnText}>Browse your Word File</Text>
            </TouchableOpacity>
          ) : (
